...
const messages = {
  en: {
    source: "Source", profile: "Prepare", compose: "Compose", sourceData: "Data source", profileData: "Prepare data", composeData: "Compose datasets",
    ...
    openedFiles: "Flow sources", openedFilesDescription: "Saved sources in this flow", noOpenedFiles: "No sources have been added yet.", relink: "Re-link", restoringSource: "Restoring…", relinkRequired: "Re-link this source before opening Prepare.", relinkFailed: "The source could not be re-linked.", relinkMismatch: "The selected file does not match the saved source.", flowRestoreFailed: "The saved flow could not be restored.", resetAll: "Reset all", resettingAll: "Resetting…", confirmResetAll: "Reset the entire flow?", resetAllDescription: "All sources, Prepare recipes, and Compose nodes in this browser will be removed. Original device and cloud files will not be deleted.", resetAllFailed: "The flow could not be reset.", resetAllCleanupFailed: "The flow was reset, but some old local metadata could not be cleared.",
    ...
    emptyCells: "empty cells", mixedColumns: "mixed-type columns", semanticFields: "semantic fields", qualityLoadFailed: "Node quality could not be loaded.", noBasicIssues: "No basic issues detected.",
    ...
    aggregateTitle: "Value frequency by column", columnsShown: "{shown} of {total} columns shown", chooseColumns: "Choose columns", formulaColumn: "Formula column",
    formulaEditorDescription: "Create one column from a safe row-level expression.", formulaOutputColumn: "New column name", formulaOutputPlaceholder: "delivery_category", formulaExpression: "Formula", formulaInsertColumn: "Insert column", formulaInsertFunction: "Insert function", formulaColumnSuggestions: "Column suggestions", formulaFunctionSuggestions: "Function suggestions", formulaFunction: "Function", formulaFunctionSyntax: "Function syntax", formulaActiveArgument: "Argument {count}: {argument}", insert: "Insert", formulaInferredType: "Result type", formulaReferences: "Referenced columns", formulaAtCharacter: "at character {count}", formulaCreateOnlyCollision: "P0 creates a new column. Choose a name that does not already exist.", formulaPreview: "Formula preview", formulaPreviewFailed: "Formula preview could not be created.", formulaApplyFailed: "Formula column could not be applied.", editFormulaColumn: "Edit formula column", preview: "Preview",
    ...
    editStep: "Edit step", previewStep: "Preview after step", deleteStep: "Delete step", confirmDeleteStep: "Delete this step?", deleteAllSteps: "Delete all", confirmDeleteAllStep: "Delete the only recipe step?", confirmDeleteAllSteps: "Delete all {count} steps?", deleteAllStepsDescription: "The active Prepare dataset will return to its source state. Undo can restore the complete recipe.", noTransforms: "No transformations yet",
    ...
    leftOnly: "Left only", rightOnly: "Right only", leftOnlyDescription: "Rows missing from the right", rightOnlyDescription: "Rows missing from the left", groupBy: "Group by", measure: "Measure", aggregateFunction: "Calculation", alias: "Output name", comparisonColumns: "Comparison columns", filterColumn: "Column", filterOperator: "Condition", filterValue: "Value", filterValueRequired: "Enter a comparison value.", pivotColumn: "Pivot column", pivotValues: "Values (comma-separated)", unpivotColumns: "Columns to unpivot", fieldColumnName: "Field column name", valueColumnName: "Value column name", addMetric: "Add metric", removeMetric: "Remove metric", percentile: "Percentile", minimumSampleSize: "Minimum sample size", suppressSmallGroups: "Suppress small groups", distinctOutputMode: "Output mode", representativeRows: "Keep representative rows", projectDistinctColumns: "Return distinct columns only", reusableMetric: "Reusable metrics", addReusableMetric: "Add a saved metric…",
    ...
    settings: "Settings", connectionTargetHint: "Now click the whole card for the second input.", createPreparedDataset: "Create dataset", createPreparedDatasetHint: "Open this result as an independent dataset in Prepare", duplicatePreparedDatasetHint: "Create an independent copy of this Prepare dataset", deletePreparedDataset: "Delete prepared dataset", confirmDeletePreparedDataset: "Delete this dataset?", deleteOperation: "Delete operation", confirmDeleteOperation: "Delete this operation?", confirmDeleteMetricDefinition: "Delete this reusable metric definition?", keepOperation: "Keep", delete: "Delete", deleteDownstreamFirst: "Delete downstream operations first.",
  ...
  id: {
    source: "Sumber", profile: "Siapkan", compose: "Gabungkan", sourceData: "Sumber data", profileData: "Siapkan data", composeData: "Gabungkan dataset",
    ...
    openedFiles: "Sumber flow", openedFilesDescription: "Sumber tersimpan dalam flow ini", noOpenedFiles: "Belum ada sumber yang ditambahkan.", relink: "Hubungkan ulang", restoringSource: "Memulihkan…", relinkRequired: "Hubungkan ulang sumber ini sebelum membuka Prepare.", relinkFailed: "Sumber tidak dapat dihubungkan ulang.", relinkMismatch: "File yang dipilih tidak cocok dengan sumber tersimpan.", flowRestoreFailed: "Flow tersimpan tidak dapat dipulihkan.", resetAll: "Reset semua", resettingAll: "Mereset…", confirmResetAll: "Reset seluruh flow?", resetAllDescription: "Semua sumber, recipe Prepare, dan node Compose di browser ini akan dihapus. File asli di perangkat dan cloud tidak akan dihapus.", resetAllFailed: "Flow tidak dapat direset.", resetAllCleanupFailed: "Flow telah direset, tetapi sebagian metadata lokal lama tidak dapat dibersihkan.",
    ...
    emptyCells: "sel kosong", mixedColumns: "kolom tipe campuran", semanticFields: "field semantic", qualityLoadFailed: "Quality node tidak dapat dimuat.", noBasicIssues: "Tidak ada masalah dasar yang terdeteksi.",
    ...
    aggregateTitle: "Agregat nilai per kolom", columnsShown: "{shown} dari {total} kolom ditampilkan", chooseColumns: "Pilih kolom", formulaColumn: "Kolom rumus",
    formulaEditorDescription: "Buat satu kolom dari ekspresi aman per baris.", formulaOutputColumn: "Nama kolom baru", formulaOutputPlaceholder: "kategori_pengiriman", formulaExpression: "Rumus", formulaInsertColumn: "Sisipkan kolom", formulaInsertFunction: "Sisipkan fungsi", formulaColumnSuggestions: "Saran kolom", formulaFunctionSuggestions: "Saran fungsi", formulaFunction: "Fungsi", formulaFunctionSyntax: "Sintaks fungsi", formulaActiveArgument: "Argumen {count}: {argument}", insert: "Sisipkan", formulaInferredType: "Tipe hasil", formulaReferences: "Kolom rujukan", formulaAtCharacter: "pada karakter {count}", formulaCreateOnlyCollision: "P0 hanya membuat kolom baru. Gunakan nama yang belum ada.", formulaPreview: "Pratinjau rumus", formulaPreviewFailed: "Pratinjau rumus tidak dapat dibuat.", formulaApplyFailed: "Kolom rumus tidak dapat diterapkan.", editFormulaColumn: "Ubah kolom rumus", preview: "Pratinjau",
    ...
    editStep: "Edit langkah", previewStep: "Pratinjau setelah langkah", deleteStep: "Hapus langkah", confirmDeleteStep: "Hapus langkah ini?", deleteAllSteps: "Hapus semua", confirmDeleteAllStep: "Hapus satu-satunya langkah recipe?", confirmDeleteAllSteps: "Hapus semua {count} langkah?", deleteAllStepsDescription: "Dataset Prepare aktif akan kembali ke kondisi sumber. Undo dapat memulihkan seluruh recipe.", noTransforms: "Belum ada transformasi",
...
const toolMessages = {
  en: {
    ...
    sort: "Sort rows", "calculated-field": "Formula column", "calculated-column": "Calculated column", "conditional-column": "Conditional column", "group-aggregate": "Group & aggregate",
  },
  id: Object.fromEntries([
    ...
    ["sort", "Urutkan baris"], ["calculated-field", "Kolom rumus"], ["calculated-column", "Kolom perhitungan"], ["conditional-column", "Kolom bersyarat"], ["group-aggregate", "Kelompokkan & agregasi"],
  ]),
};
