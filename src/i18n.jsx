...
const messages = {
  en: {
    ...
    formulaEditorDescription: "Create one column from a safe row-level expression.", formulaOutputColumn: "New column name", formulaOutputPlaceholder: "delivery_category", formulaExpression: "Formula", formulaInsertColumn: "Insert column", formulaInsertFunction: "Insert function", insert: "Insert", formulaInferredType: "Result type", formulaReferences: "Referenced columns", formulaAtCharacter: "at character {count}", formulaCreateOnlyCollision: "P0 creates a new column. Choose a name that does not already exist.", formulaPreview: "Formula preview", formulaPreviewFailed: "Formula preview could not be created.", formulaApplyFailed: "Formula column could not be applied.", editFormulaColumn: "Edit formula column", preview: "Preview",
