...
const messages = {
  en: {
    ...
    settings: "Settings", connectionTargetHint: "Now click the whole card for the second input.", connectAnotherNode: "Connect another node", connectAnotherNodeHint: "Choose a second input for Join, Append, or Difference", createPreparedDataset: "Create dataset", createPreparedDatasetHint: "Open this result as an independent dataset in Prepare", duplicatePreparedDatasetHint: "Create an independent copy of this Prepare dataset", deletePreparedDataset: "Delete prepared dataset", confirmDeletePreparedDataset: "Delete this dataset?", deleteOperation: "Delete operation", confirmDeleteOperation: "Delete this operation?", keepOperation: "Keep", delete: "Delete", deleteDownstreamFirst: "Delete downstream operations first.",
    ...
    outputColumns: "Output columns", previewSchema: "Preview schema", createNode: "Create node", unsavedChanges: "Unsaved changes",
  ...
  id: {
    ...
    outputColumns: "Kolom output", previewSchema: "Pratinjau schema", createNode: "Buat node", unsavedChanges: "Perubahan belum tersimpan",
